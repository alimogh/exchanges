...
const debug = require('debug')('cointrage:exchanges:bigone');

const API_URL = 'https://api.big.one';
...
const getMarkets = () => new Promise((resolve, reject) => {
    ...
    request({
        ...
        for (let mt of body.data) {
            let [market, ticker] = [mt.base, mt.quote];
...
const getOrderBook = (market, ticker) => new Promise((resolve, reject) => {
    ...
    const url = `${API_URL}/markets/${ticker}-${market}/book`;
